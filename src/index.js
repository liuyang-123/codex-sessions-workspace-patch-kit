...
const PATCH_ID = "codex-sessions-workspace-patch-v8";
...
const PATCHES = [
  ...
  },
  {
    ...
    find:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new av(!0);prewarmedThreads=new iv",
    replace:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;threadListRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new av(!0);prewarmedThreads=new iv",
  },
  {
