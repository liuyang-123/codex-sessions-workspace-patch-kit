...
const PATCH_ID = "codex-sessions-workspace-patch-v9";
...
const PATCHES = [
  ...
  },
  {
    ...
    find:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new ov(!0);prewarmedThreads=new rv",
    replace:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;threadListRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new ov(!0);prewarmedThreads=new rv",
  },
  {
