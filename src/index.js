...
const PATCH_ID = "codex-sessions-workspace-patch-v10";
...
const PATCHES = [
  ...
  },
  {
    ...
    find:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new uv(!0);prewarmedThreads=new cv",
    replace:
      "pendingNotifications=[];internalNotificationHandlers=new Set;ephemeralThreadTimeouts=new Map;pendingPrewarmedThreadStartRequestIds=new Set;threadListRequestIds=new Set;pendingTurnStartRequestIds=new Set;turnCwds=new uv(!0);prewarmedThreads=new cv",
  },
  {
    ...
    find:
      "sendProviderRequest(e,r,n,o,i){let s=`${e}:${r}`;i&&this.pendingPrewarmedThreadStartRequestIds.add(s);let a={id:s,method:n,params:o};if(this.recordLastOutboundMethod(n),!this.sendMessage(a)||n!==\"turn/start\")return;this.pendingTurnStartRequestIds.add(s),this.turnCwds.track(o,s);let c=Hm(o);c!=null&&this.prewarmedThreads.publishThreadStarted(c)}",
    replace:
      "sendProviderRequest(e,r,n,o,i){let s=`${e}:${r}`;i&&this.pendingPrewarmedThreadStartRequestIds.add(s),(e===\"codex.chatSessionProvider\"||e===\"CodexWebviewProvider.webview\")&&n===\"thread/list\"&&(this.threadListRequestIds.add(s),o={...o,limit:Math.max(Number(o?.limit)||0,500)});let a={id:s,method:n,params:o};if(this.recordLastOutboundMethod(n),!this.sendMessage(a)||n!==\"turn/start\")return;this.pendingTurnStartRequestIds.add(s),this.turnCwds.track(o,s);let c=Hm(o);c!=null&&this.prewarmedThreads.publishThreadStarted(c)}",
  },
  {
